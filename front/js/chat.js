        ...
        try {
            ...
            if (response.ai_text) {  // AI 텍스트가 있는 경우
                ...
                if (response.audio) {  // 오디오가 있는 경우
                    ...
                    await chatManager.isPlaying = true;  // 재생 중 플래그 설정
                    await live2dManager.setExpression('speaking');  // 'speaking' 표정 설정
                    ...
                    try {
                        ...
                        await live2dManager.setExpression('neutral');  // 'neutral' 표정 설정
